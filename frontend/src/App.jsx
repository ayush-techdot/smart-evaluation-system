      ...
      <BrowserRouter>
        <Toaster
          ...
          toastOptions={{
            ...
            success: { iconTheme: { primary: '#06d6a0', secondary: '#0a0a12' } },
        ...
        <Routes>
          ...
          <Route path="/exams/new" element={
            <ProtectedRoute><Layout><CreateExam /></Layout></ProtectedRoute>
          } />
          <Route path="/exams/:id/upload" element={
            <ProtectedRoute><Layout><UploadSheet /></Layout></ProtectedRoute>
          } />
