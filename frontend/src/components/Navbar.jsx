  ...
  return (
    <nav style={{
      ...
      <Link to="/dashboard" style={{ display: 'flex', alignItems: 'center', gap: 10, textDecoration: 'none' }}>
        ...
        <span style={{ fontWeight: 700, fontSize: 16, color: 'var(--text)' }}>Smart<span style={{ color: 'var(--accent)' }}>Eval</span></span>
      </Link>

      {user && (
        <div style={{ display: 'flex', alignItems: 'center', gap: 16 }}>
          <Link to="/dashboard" className="btn btn-secondary btn-sm" style={{ gap: 6 }}>
